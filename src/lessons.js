...
export function registerLessons(bot) {
  ...
  bot.callbackQuery('slots:days', async (ctx) => {
    ...
    const text =
      ...
      '<b>Занятия с Ангелиной</b>\n' +
      'Разовое: 45 мин — 12 €, 60 мин — 14 €\n' +
      'Абонемент 10 занятий: 45 мин — 114 €, 60 мин — 130 €\n\n' +
      '<b>Занятия с преподавателем команды</b>\n' +
      'Разовое: 45 мин — 10 €, 60 мин — 12 €\n' +
      'Абонемент 10 занятий: 45 мин — 95 €, 60 мин — 110 €\n\n' +
      '💳 Оплата <b>до урока</b> на Monobank / PayPal — в гривнах, долларах или евро.\n' +
      '❌ Карты и рубли РФ/РБ не принимаются.\n\n' +
      'У Ангелины сейчас нет свободных мест для новых учеников, ' +
      'но начать можно с проверенным преподавателем команды — ' +
      'все работают под её контролем и по её методике.\n\n' +
