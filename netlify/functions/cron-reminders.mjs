// Крон: утреннее напоминание ученикам (12:00 Киев), продления (10:00 Киев)
...
export default async () => {
  ...
  await bot.init();
  try {
    let renewals = 0, winback = 0, evening = 0, morning = 0;
    ...
    console.log(`renewals:${renewals} winback:${winback} morning:${morning} evening:${evening}`);
